...
class ExperimentPlanBuilder:
	...
	def __init__(self, name: str, description: str = ''):
		self.config = ExperimentPlan(name=name, description=description)

	def altruism_range(self, values: list[float]) -> 'ExperimentPlanBuilder':
	...
	def tau_range(self, values: list[float]) -> 'ExperimentPlanBuilder':
	...
	def epsilon_fresh_range(self, values: list[float]) -> 'ExperimentPlanBuilder':
	...
	def epsilon_mono_range(self, values: list[float]) -> 'ExperimentPlanBuilder':
...
class ExperimentRunner:
	...
	def _build_task_args(
		self, sim_config: SimulationConfig, config: ExperimentPlan, combination_count: int
	...
	def run_test(self, config: ExperimentPlan) -> list[SimulationResult]:
		"""
	...
	def run_multiple_tests(
		self, configs: list[ExperimentPlan]
	...
	def _count_combinations(self, config: ExperimentPlan) -> int:
	...
	def _generate_parameter_combinations(self, config: ExperimentPlan) -> list[dict[str, Any]]:
		"""Generate all parameter combinations."""
		combinations = []
...
def create_altruism_comparison_experiment() -> ExperimentPlan:
	"""Create a test comparing different altruism probabilities."""
	return (
		ExperimentPlanBuilder('altruism_comparison', 'Compare different altruism probabilities')
...
def create_random_players_experiment(num_random: int) -> ExperimentPlan:
	"""Create a test against random players."""
	return (
		ExperimentPlanBuilder(f'random_{num_random}', f'Test against {num_random} random players')
...
def create_scalability_experiment() -> ExperimentPlan:
	"""Create a scalability test with different numbers of random players."""
	return (
		ExperimentPlanBuilder('scalability', 'Test scalability with different random player counts')
...
def create_parameter_sweep_experiment() -> ExperimentPlan:
	"""Create a comprehensive parameter sweep test."""
	return (
		ExperimentPlanBuilder('parameter_sweep', 'Comprehensive parameter sweep')
...
def create_mixed_opponents_experiment() -> ExperimentPlan:
	"""Create a test against mixed opponent types."""
	return (
		ExperimentPlanBuilder('mixed_opponents', 'Test against mixed opponent types')
		.altruism_range([0.0, 0.2, 0.5, 1.0])
...
def run_example_experiments():
	...
	tests = [
		...
		create_random_players_experiment(5),
