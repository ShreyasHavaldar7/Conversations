...
def main() -> None:
    ...
    parser.add_argument('--ci-group', nargs='+', default=['altruism_prob'], help='Grouping columns for CI')
    parser.add_argument('--ci-metric', default='total_score', help='Metric used in bootstrap CI')
    parser.add_argument('--ci-iterations', type=int, default=1000, help='Bootstrap iterations (default 1000)')
    parser.add_argument('--ci-confidence', type=float, default=0.95, help='Confidence level (default 0.95)')
    parser.add_argument('--pairwise', action='store_true', help='Report pairwise mean deltas & effect sizes')
    parser.add_argument('--pairwise-group', default='altruism_prob', help='Column defining pairwise cohorts')
    parser.add_argument('--pairwise-metric', default='total_score', help='Metric analysed for pairwise deltas')
    parser.add_argument('--plot', choices=['altruism', 'heatmap', 'components', 'pareto', 'rank', 'seed', 'corr', 'multi-heatmap'], help='Generate a quick matplotlib plot')
    parser.add_argument('--param1', default='altruism_prob', help='Primary parameter (rows) for heatmap plots')
    parser.add_argument('--param2', default='tau_margin', help='Secondary parameter (cols) for heatmap plots')
    parser.add_argument('--metric', default='total_score', help='Metric for heatmaps / stability / pairwise')
    parser.add_argument('--fixed', default='altruism_prob', help='Facet parameter for multi-heatmap')
